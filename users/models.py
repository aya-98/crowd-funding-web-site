...
#     phone_regex = RegexValidator(regex=r'^01[1|0|2|5][0-9]{8}$',message='Please Enter Egyptian phone number ')
...
#     email = models.EmailField(verbose_name='email', null=False, max_length=120,unique=True)
#     phone = models.CharField(verbose_name="phone",null=False,validators=[phone_regex],max_length=11)
#     photo = models.ImageField(verbose_name="photo",upload_to='users')
...
class User(AbstractBaseUser):
    ...
    phone = models.CharField(verbose_name="phone",null=True,validators=[phone_regex],max_length=11)
    photo = models.ImageField(default=None, blank=True, null=True, upload_to='uploads/')
    date_birth = models.DateField(null=True)
    facebook_link = models.URLField(null=True)
    country = models.CharField(max_length=50, null=True)
