...
class Projects(models.Model):
    ...
    category = models.ForeignKey(
        'Categories', null=False, on_delete=models.CASCADE)
...
class Project_tags(models.Model):
    project = models.ForeignKey(
        'Projects', null=False, on_delete=models.CASCADE)
    tag = models.ForeignKey('Tags', null=False, on_delete=models.CASCADE)
